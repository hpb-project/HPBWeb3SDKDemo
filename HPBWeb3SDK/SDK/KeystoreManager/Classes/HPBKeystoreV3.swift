...
public class HPBKeystoreV3: AbstractKeystore {
    // Class
    
    public func getAddress() -> HPBAddress? {
        return self.address
    }
    ...
    // --------------
    private var address: HPBAddress?
    ...
    public init?(_ keystoreParams: KeystoreParamsV3) {
        ...
        if keystoreParams.address != nil {
            self.address = HPBAddress(keystoreParams.address!,ignoreChecksum: true)
        } else {
            return nil
        }
    }
