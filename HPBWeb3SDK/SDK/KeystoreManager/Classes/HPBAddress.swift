...
public struct HPBAddress: Equatable {
    ...
    public static func ==(lhs: HPBAddress, rhs: HPBAddress) -> Bool {
...
//                return d
    ...
    public var address:String {
        switch self.type {
        case .normal:
            return HPBAddress.toChecksumAddress(_address)!
        case .contractDeployment:
            return "0x"
        }
    }
    ...
    public init?(_ addressString:String, type: AddressType = .normal, ignoreChecksum: Bool = false) {
        ...
        case .normal:
            ...
            if (!ignoreChecksum && data.toHexString().addHexPrefix() != addressString) {
                let checksummedAddress = HPBAddress.toChecksumAddress(data.toHexString().addHexPrefix())
    ...
    public static func contractDeploymentAddress() -> HPBAddress {
        return HPBAddress("0x", type: .contractDeployment)!
    }
    
//    public static func fromIBAN(_ iban: String) -> HPBAddress {
//
//    }
