...
//    public var mnemonics: String?
    public var paths: [String:HPBAddress] = [String:HPBAddress]()
    ...
    fileprivate func encryptDataToStorage(_ password: String, data: Data?, dkLen: Int=32, N: Int = 4096, R: Int = 6, P: Int = 1) throws {
        ...
        let aecCipher = try? AES(key: encryptionKey.bytes, blockMode: .CTR(iv: IV.bytes), padding: .pkcs7)
