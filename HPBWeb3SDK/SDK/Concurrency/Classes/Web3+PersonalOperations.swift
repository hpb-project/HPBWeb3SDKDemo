...
final class PersonalUnlockAccountOperation: Web3Operation {
    convenience init(_ web3Instance: web3, queue: OperationQueue? = nil, account: HPBAddress, password: String = "BANKEXFOUNDATION", seconds: UInt64 = 300) {
...
final class PersonalSignOperation: Web3Operation {
    ...
    convenience init(_ web3Instance: web3, queue: OperationQueue? = nil, message: Data, from: HPBAddress, password:String = "BANKEXFOUNDATION") {
    ...
    override func main() {
        ...
        guard let from = input[1] as? HPBAddress else {return processError(Web3Error.inputError("Invalid input supplied"))}
