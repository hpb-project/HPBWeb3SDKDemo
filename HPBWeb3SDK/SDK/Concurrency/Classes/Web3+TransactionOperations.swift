...
final class ContractCallOperation: Web3Operation {
    ...
    override func main() {
        ...
        guard let request = HPBTransaction.createRequest(method: JSONRPCmethod.call, transaction: transaction, onBlock: onBlock, options: mergedOptions) else {return self.processError(Web3Error.inputError("Invalid input supplied"))}
