...
public struct Web3Signer {
    public static func signTX(transaction:inout HPBTransaction, keystore: AbstractKeystore, account: HPBAddress, password: String, useExtraEntropy: Bool = true) throws {
    ...
    public static func signIntermediate(intermediate:inout TransactionIntermediate, keystore: AbstractKeystore, account: HPBAddress, password: String, useExtraEntropy: Bool = true) throws {
    ...
    public static func signPersonalMessage(_ personalMessage: Data, keystore: AbstractKeystore, account: HPBAddress, password: String, useExtraEntropy: Bool = true) throws -> Data? {
        var privateKey = try keystore.UNSAFE_getPrivateKeyData(password: password, account: account)
        defer {Data.zero(&privateKey)}
    ...
    public struct EIP155Signer {
        public static func sign(transaction:inout HPBTransaction, privateKey: Data, useExtraEntropy: Bool = true) throws {
            for _ in 0..<1024 {
        ...
        private static func attemptSignature(transaction:inout HPBTransaction, privateKey: Data, useExtraEntropy: Bool = true) -> Bool {
    ...
    public struct FallbackSigner {
        ...
        private static func attemptSignature(transaction:inout HPBTransaction, privateKey: Data, useExtraEntropy: Bool = false) -> Bool {
