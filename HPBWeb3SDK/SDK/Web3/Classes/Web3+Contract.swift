...
extension web3 {
    ...
    public func contract(_ abiString: String, at: HPBAddress? = nil, abiVersion: Int = 2) -> web3contract? {
    ...
    public class web3contract {
        ...
        public init?(web3 web3Instance:web3, abiString: String, at: HPBAddress? = nil, options: Web3Options? = nil, abiVersion: Int = 2) {
