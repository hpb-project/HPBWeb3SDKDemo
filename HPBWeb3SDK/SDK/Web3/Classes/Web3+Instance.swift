...
public class web3: Web3OptionsInheritable {
    ...
    var hpbInstance: web3.Hpb?
    public var hpb: web3.Hpb {
        if (self.hpbInstance != nil) {
            return self.hpbInstance!
        }
        self.hpbInstance = web3.Hpb(provider : self.provider, web3: self)
        return self.hpbInstance!
    }
    
    public class Hpb:Web3OptionsInheritable {
