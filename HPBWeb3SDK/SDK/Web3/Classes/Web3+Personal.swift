...
extension web3.Personal {
    func signPersonalMessage(message: Data, from: HPBAddress, password:String = "BANKEXFOUNDATION", callback: @escaping Callback, queue: OperationQueue = OperationQueue.main) {
    ...
    public func signPersonalMessage(message: Data, from: HPBAddress, password:String = "BANKEXFOUNDATION") -> Result<Data, Web3Error> {
    ...
    func unlockAccount(account: HPBAddress, password:String = "BANKEXFOUNDATION", seconds: UInt64 = 300, callback: @escaping Callback, queue: OperationQueue = OperationQueue.main) {
    ...
    public func unlockAccount(account: HPBAddress, password:String = "BANKEXFOUNDATION", seconds: UInt64 = 300) -> Result<Bool, Web3Error> {
...
//        }
    ...
    public func ecrecover(personalMessage: Data, signature: Data) -> Result<HPBAddress, Web3Error> {
    ...
    public func ecrecover(hash: Data, signature: Data) -> Result<HPBAddress, Web3Error> {
