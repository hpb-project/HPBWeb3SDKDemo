...
public class InfuraProvider: Web3HttpProvider {
    ...
    enum supportedPostMethods: String {
        case hpb_estimateGas = "hpb_estimateGas"
        case hpb_sendRawTransaction = "hpb_sendRawTransaction"
    }
    
    enum supportedGetMethods: String{
        case hpb_call = "hpb_call"
        case hpb_getTransactionCount = "hpb_getTransactionCount"
    }
