...
extension web3.web3contract {
    public struct EventParser: EventParserProtocol {
        ...
        public func parseBlockByNumber(_ blockNumber: UInt64) -> Result<[EventParserResultProtocol], Web3Error> {
            ...
            let response = web3.hpb.getBlockByNumber(blockNumber)
            switch response {
        ...
        public func parseTransaction(_ transaction: HPBTransaction) -> Result<[EventParserResultProtocol], Web3Error> {
